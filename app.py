            ...
            <div class="container">
              <div class="nav-inner">
                <a href="{home_href}" class="brand" aria-label="{UI_BRAND['name']} home">
                  <img src="{UI_BRAND.get('logo','/static/logos/hurkfield-logo.jpeg')}" alt="{UI_BRAND['name']} logo" style="height:64px; width:auto; max-width:310px; object-fit:contain; display:block;" />
                </a>
        ...
        <head>
          ...
          <style>
            ...
            *{{box-sizing:border-box}}
            ...
            .brand img{{height:56px; width:auto; max-width:300px; display:block}}
    ...
    <div class="bg-white border border-violet-100 rounded-[28px] shadow-[0_26px_90px_-36px_rgba(124,58,237,0.48)] overflow-hidden grid lg:grid-cols-2">
      <div class="p-8 sm:p-10 text-white bg-gradient-to-br from-violet-700 via-fuchsia-600 to-indigo-600">
        <a href="/" class="inline-flex items-center">
          <img src="/static/logos/hurkfield-logo.jpeg" alt="HurkField logo" class="h-16 w-auto object-contain" />
        </a>
